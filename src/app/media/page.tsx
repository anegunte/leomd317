        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
          {filteredMedia.map((item) => (
            <div
              ...
              className="break-inside-avoid relative rounded-2xl overflow-hidden border border-white/5 bg-bg-panel/40 hover:border-gold-primary/20 transition-all duration-300 group cursor-pointer shadow-lg"
            >
              ...
              <div className="relative w-full h-auto overflow-hidden">
                <img
                  src={item.thumbnail}
                  alt={item.title}
                  className="w-full h-auto object-cover filter brightness-95 group-hover:brightness-75 group-hover:scale-101 transition-all duration-500"
                />
                ...
                {/* Media type icon tag */}
                <span className="absolute top-4 right-4 p-1.5 rounded-lg bg-bg-deep-space/75 border border-white/10 text-gold-light">
